...
export enum DataObjectRunState {
  REQUESTED = 'REQUESTED',
  QUEUED = 'QUEUED',
...
@Entity('dataobject_runs')
export class DataObjectRun {
  ...
  @Column({type: 'nvarchar', length: 100, enum: DataObjectRunState, nullable: false})
  state: DataObjectRunState;
